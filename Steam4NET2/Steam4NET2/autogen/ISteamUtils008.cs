...
namespace Steam4NET
{
	...
	public class ISteamUtils008VTable
	{
		...
		public IntPtr IsSteamInBigPictureMode26;
		public IntPtr StartVRDashboard27;
		private IntPtr DTorISteamUtils00828;
	};
	
	[InteropHelp.InterfaceVersion("SteamUtils008")]
	public class ISteamUtils008 : InteropHelp.NativeWrapper<ISteamUtils008VTable>
	{
		...
		[return: MarshalAs(UnmanagedType.I1)]
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeIsSteamInBigPictureMode( IntPtr thisptr );
		public bool IsSteamInBigPictureMode(  ) 
		{
			return this.GetFunction<NativeIsSteamInBigPictureMode>( this.Functions.IsSteamInBigPictureMode26 )( this.ObjectAddress ); 
		}
		...
		{
			this.GetFunction<NativeStartVRDashboard>( this.Functions.StartVRDashboard27 )( this.ObjectAddress ); 
		}
