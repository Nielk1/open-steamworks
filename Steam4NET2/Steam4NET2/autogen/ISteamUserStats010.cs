...
namespace Steam4NET
{
	...
	public class ISteamUserStats010 : InteropHelp.NativeWrapper<ISteamUserStats010VTable>
	{
		...
		{
			return this.GetFunction<NativeGetUserAchievementAndUnlockTimeCSBU>( this.Functions.GetUserAchievementAndUnlockTime18 )( this.ObjectAddress, steamIDUser.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), ref pbAchieved, ref punUnlockTime ); 
		}
		...
		{
			return this.GetFunction<NativeGetAchievementAchievedPercentSF>( this.Functions.GetAchievementAchievedPercent35 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), ref pflPercent ); 
		}
		...
		{
			return this.GetFunction<NativeGetGlobalStatSD>( this.Functions.GetGlobalStat37 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchStatName ).GetMarshaledBytes(), ref pData ); 
		}
		...
		{
			return this.GetFunction<NativeGetGlobalStatSI>( this.Functions.GetGlobalStat38 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchStatName ).GetMarshaledBytes(), ref pData ); 
		}
		...
		{
			return this.GetFunction<NativeGetGlobalStatHistorySDU>( this.Functions.GetGlobalStatHistory39 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchStatName ).GetMarshaledBytes(), ref pData, cubData ); 
		}
		...
		{
			return this.GetFunction<NativeGetGlobalStatHistorySIU>( this.Functions.GetGlobalStatHistory40 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchStatName ).GetMarshaledBytes(), ref pData, cubData ); 
		}
