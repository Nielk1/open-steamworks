...
namespace Steam4NET
{
	...
	public class ISteamUser020VTable
	{
		...
		public IntPtr RequestStoreAuthURL24;
		public IntPtr BIsPhoneVerified25;
		public IntPtr BIsTwoFactorEnabled26;
		public IntPtr BIsPhoneIdentifying27;
		public IntPtr BIsPhoneRequiringVerification28;
		private IntPtr DTorISteamUser02029;
	};
	
	public class ISteamUser020 : InteropHelp.NativeWrapper<ISteamUser020VTable>
	{
		...
		{
			return this.GetFunction<NativeBIsPhoneVerified>( this.Functions.BIsPhoneVerified25 )( this.ObjectAddress ); 
		}
		
		[return: MarshalAs(UnmanagedType.I1)]
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeBIsTwoFactorEnabled( IntPtr thisptr );
		public bool BIsTwoFactorEnabled(  ) 
		{
			return this.GetFunction<NativeBIsTwoFactorEnabled>( this.Functions.BIsTwoFactorEnabled26 )( this.ObjectAddress ); 
		}
		...
		{
			return this.GetFunction<NativeBIsPhoneIdentifying>( this.Functions.BIsPhoneIdentifying27 )( this.ObjectAddress ); 
		}
		...
		{
			return this.GetFunction<NativeBIsPhoneRequiringVerification>( this.Functions.BIsPhoneRequiringVerification28 )( this.ObjectAddress ); 
		}
