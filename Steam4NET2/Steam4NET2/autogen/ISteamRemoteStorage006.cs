...
namespace Steam4NET
{
	...
	public class ISteamRemoteStorage006 : InteropHelp.NativeWrapper<ISteamRemoteStorage006VTable>
	{
		...
		{
			return this.GetFunction<NativeFileExistsS>( this.Functions.FileExists6 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeFilePersistedS>( this.Functions.FilePersisted7 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeGetFileSizeS>( this.Functions.GetFileSize8 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeGetFileTimestampS>( this.Functions.GetFileTimestamp9 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeGetSyncPlatformsS>( this.Functions.GetSyncPlatforms10 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetFileNameAndSizeII>( this.Functions.GetFileNameAndSize12 )( this.ObjectAddress, iFile, ref pnFileSizeInBytes ) ); 
		}
		...
		{
			return this.GetFunction<NativeUpdatePublishedFileFileUS>( this.Functions.UpdatePublishedFileFile25 )( this.ObjectAddress, hUpdateRequest, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeUpdatePublishedFilePreviewFileUS>( this.Functions.UpdatePublishedFilePreviewFile26 )( this.ObjectAddress, hUpdateRequest, InteropHelp.Utf8StringToPtr( pchPreviewFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeUpdatePublishedFileTitleUS>( this.Functions.UpdatePublishedFileTitle27 )( this.ObjectAddress, hUpdateRequest, InteropHelp.Utf8StringToPtr( pchTitle ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeUpdatePublishedFileDescriptionUS>( this.Functions.UpdatePublishedFileDescription28 )( this.ObjectAddress, hUpdateRequest, InteropHelp.Utf8StringToPtr( pchDescription ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeUpdatePublishedFileSetChangeDescriptionUS>( this.Functions.UpdatePublishedFileSetChangeDescription38 )( this.ObjectAddress, hUpdateRequest, InteropHelp.Utf8StringToPtr( cszDescription ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativePublishVideoSSUSSES>( this.Functions.PublishVideo43 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( cszFileName ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( cszPreviewFileName ).GetMarshaledBytes(), nConsumerAppId, InteropHelp.Utf8StringToPtr( cszTitle ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( cszDescription ).GetMarshaledBytes(), eVisibility, ref pTags ); 
		}
