...
namespace Steam4NET
{
	...
	public class ISteamFriends014 : InteropHelp.NativeWrapper<ISteamFriends014VTable>
	{
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetPlayerNicknameC>( this.Functions.GetPlayerNickname10 )( this.ObjectAddress, steamIDPlayer.ConvertToUint64() ) ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetClanTagC>( this.Functions.GetClanTag15 )( this.ObjectAddress, steamIDClan.ConvertToUint64() ) ); 
		}
		...
		{
			this.GetFunction<NativeActivateGameOverlayS>( this.Functions.ActivateGameOverlay22 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchDialog ).GetMarshaledBytes() ); 
		}
		...
		{
			this.GetFunction<NativeActivateGameOverlayToUserSC>( this.Functions.ActivateGameOverlayToUser23 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchDialog ).GetMarshaledBytes(), steamID.ConvertToUint64() ); 
		}
		...
		{
			this.GetFunction<NativeActivateGameOverlayToWebPageS>( this.Functions.ActivateGameOverlayToWebPage24 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchURL ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeSetRichPresenceSS>( this.Functions.SetRichPresence37 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchValue ).GetMarshaledBytes() ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetFriendRichPresenceCS>( this.Functions.GetFriendRichPresence39 )( this.ObjectAddress, steamIDFriend.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ) ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetFriendRichPresenceKeyByIndexCI>( this.Functions.GetFriendRichPresenceKeyByIndex41 )( this.ObjectAddress, steamIDFriend.ConvertToUint64(), iKey ) ); 
		}
		...
		{
			return this.GetFunction<NativeInviteUserToGameCS>( this.Functions.InviteUserToGame43 )( this.ObjectAddress, steamIDFriend.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchConnectString ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeSendClanChatMessageCS>( this.Functions.SendClanChatMessage52 )( this.ObjectAddress, steamIDClanChat.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchText ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeReplyToFriendMessageCS>( this.Functions.ReplyToFriendMessage59 )( this.ObjectAddress, steamIDFriend.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchMsgToSend ).GetMarshaledBytes() ); 
		}
