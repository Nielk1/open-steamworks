...
namespace Steam4NET
{
	...
	public class ISteamMatchmaking008 : InteropHelp.NativeWrapper<ISteamMatchmaking008VTable>
	{
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetLobbyDataCS>( this.Functions.GetLobbyData18 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ) ); 
		}
		...
		{
			return this.GetFunction<NativeSetLobbyDataCSS>( this.Functions.SetLobbyData19 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchValue ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeDeleteLobbyDataCS>( this.Functions.DeleteLobbyData22 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetLobbyMemberDataCCS>( this.Functions.GetLobbyMemberData23 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDUser.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ) ); 
		}
		...
		{
			this.GetFunction<NativeSetLobbyMemberDataCSS>( this.Functions.SetLobbyMemberData24 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchValue ).GetMarshaledBytes() ); 
		}
