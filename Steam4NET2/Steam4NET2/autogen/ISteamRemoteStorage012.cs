...
namespace Steam4NET
{
	...
	public class ISteamRemoteStorage012 : InteropHelp.NativeWrapper<ISteamRemoteStorage012VTable>
	{
		...
		{
			return this.GetFunction<NativeUGCDownloadToLocationUSU>( this.Functions.UGCDownloadToLocation51 )( this.ObjectAddress, hContent, InteropHelp.Utf8StringToPtr( cszLocation ).GetMarshaledBytes(), unPriority ); 
		}
