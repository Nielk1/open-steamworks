...
namespace Steam4NET
{
	...
	public class ISteamRemoteStorage003 : InteropHelp.NativeWrapper<ISteamRemoteStorage003VTable>
	{
		...
		{
			return this.GetFunction<NativeFileExistsS>( this.Functions.FileExists5 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeFilePersistedS>( this.Functions.FilePersisted6 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeGetFileSizeS>( this.Functions.GetFileSize7 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeGetFileTimestampS>( this.Functions.GetFileTimestamp8 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchFile ).GetMarshaledBytes() ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetFileNameAndSizeII>( this.Functions.GetFileNameAndSize10 )( this.ObjectAddress, iFile, ref pnFileSizeInBytes ) ); 
		}
