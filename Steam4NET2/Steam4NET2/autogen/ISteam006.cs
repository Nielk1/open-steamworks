...
namespace Steam4NET
{
	...
	public class ISteam006 : InteropHelp.NativeWrapper<ISteam006VTable>
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate UInt32 NativeOpenFileExSSIUIT( IntPtr thisptr, IntPtr cszFileName, IntPtr cszMode, Int32 nFlags, ref UInt32 puFileSize, ref Int32 pnLocal, ref TSteamError pError );
		...
		{
			return this.GetFunction<NativeOpenFileExSSIUIT>( this.Functions.OpenFileEx16 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( cszFileName ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( cszMode ).GetMarshaledBytes(), nFlags, ref puFileSize, ref pnLocal, ref pError ); 
		}
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate Int32 NativeIsFileNeededByCacheUSUT( IntPtr thisptr, UInt32 uCacheId, IntPtr cszFileName, UInt32 uFileSize, ref TSteamError pError );
		public Int32 IsFileNeededByCache( UInt32 uCacheId, string cszFileName, UInt32 uFileSize, ref TSteamError pError ) 
		{
			return this.GetFunction<NativeIsFileNeededByCacheUSUT>( this.Functions.IsFileNeededByCache129 )( this.ObjectAddress, uCacheId, InteropHelp.Utf8StringToPtr( cszFileName ).GetMarshaledBytes(), uFileSize, ref pError ); 
		}
		
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate Int32 NativeLoadFileToCacheUSBUUT( IntPtr thisptr, UInt32 uCacheId, IntPtr pchFileName, Byte[] pubDataChunk, UInt32 cubDataChunk, UInt32 cubDataOffset, ref TSteamError pError );
		...
		{
			return this.GetFunction<NativeLoadFileToCacheUSBUUT>( this.Functions.LoadFileToCache130 )( this.ObjectAddress, uCacheId, InteropHelp.Utf8StringToPtr( pchFileName ).GetMarshaledBytes(), pubDataChunk, (UInt32) pubDataChunk.Length, cubDataOffset, ref pError ); 
		}
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate Int32 NativeGetSubscriptionExtendedInfoUSSUUT( IntPtr thisptr, UInt32 uSubscriptionId, IntPtr cszKeyName, StringBuilder szKeyValue, UInt32 uBufferLength, ref UInt32 puRecievedLength, ref TSteamError pError );
		...
		{
			return this.GetFunction<NativeGetSubscriptionExtendedInfoUSSUUT>( this.Functions.GetSubscriptionExtendedInfo132 )( this.ObjectAddress, uSubscriptionId, InteropHelp.Utf8StringToPtr( cszKeyName ).GetMarshaledBytes(), szKeyValue, (UInt32) szKeyValue.Capacity, ref puRecievedLength, ref pError ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeFindServersGetErrorString>( this.Functions.FindServersGetErrorString137 )( this.ObjectAddress ) ); 
		}
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate Int32 NativeIsFileNeededByAppUSUUT( IntPtr thisptr, UInt32 uAppId, IntPtr cszFileName, UInt32 uFileSize, ref UInt32 puCacheId, ref TSteamError pError );
		...
		{
			return this.GetFunction<NativeIsFileNeededByAppUSUUT>( this.Functions.IsFileNeededByApp141 )( this.ObjectAddress, uAppId, InteropHelp.Utf8StringToPtr( cszFileName ).GetMarshaledBytes(), uFileSize, ref puCacheId, ref pError ); 
		}
		
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate UInt32 NativeWaitForAppResourcesUST( IntPtr thisptr, UInt32 uAppId, IntPtr cszMasterList, ref TSteamError pError );
		public UInt32 WaitForAppResources( UInt32 uAppId, string cszMasterList, ref TSteamError pError ) 
		{
			return this.GetFunction<NativeWaitForAppResourcesUST>( this.Functions.WaitForAppResources142 )( this.ObjectAddress, uAppId, InteropHelp.Utf8StringToPtr( cszMasterList ).GetMarshaledBytes(), ref pError ); 
		}
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate UInt32 NativeSetUser2ST( IntPtr thisptr, IntPtr cszUser, ref TSteamError pError );
		public UInt32 SetUser2( string cszUser, ref TSteamError pError ) 
		{
			return this.GetFunction<NativeSetUser2ST>( this.Functions.SetUser2150 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( cszUser ).GetMarshaledBytes(), ref pError ); 
		}
