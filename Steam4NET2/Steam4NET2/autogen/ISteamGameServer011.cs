...
namespace Steam4NET
{
	...
	public class ISteamGameServer011 : InteropHelp.NativeWrapper<ISteamGameServer011VTable>
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate void NativeLogOnSS( IntPtr thisptr, IntPtr pszAccountName, IntPtr pszPassword );
		public void LogOn( string pszAccountName, string pszPassword ) 
		{
			this.GetFunction<NativeLogOnSS>( this.Functions.LogOn5 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pszAccountName ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pszPassword ).GetMarshaledBytes() ); 
		}
