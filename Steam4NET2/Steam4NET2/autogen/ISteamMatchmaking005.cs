...
namespace Steam4NET
{
	...
	public class ISteamMatchmaking005 : InteropHelp.NativeWrapper<ISteamMatchmaking005VTable>
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate void NativeAddRequestLobbyListFilterSS( IntPtr thisptr, IntPtr pchKeyToMatch, IntPtr pchValueToMatch );
		public void AddRequestLobbyListFilter( string pchKeyToMatch, string pchValueToMatch ) 
		{
			this.GetFunction<NativeAddRequestLobbyListFilterSS>( this.Functions.AddRequestLobbyListFilter5 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchKeyToMatch ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchValueToMatch ).GetMarshaledBytes() ); 
		}
		
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate void NativeAddRequestLobbyListNumericalFilterSII( IntPtr thisptr, IntPtr pchKeyToMatch, Int32 nValueToMatch, Int32 nComparisonType );
		public void AddRequestLobbyListNumericalFilter( string pchKeyToMatch, Int32 nValueToMatch, Int32 nComparisonType ) 
		{
			this.GetFunction<NativeAddRequestLobbyListNumericalFilterSII>( this.Functions.AddRequestLobbyListNumericalFilter6 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchKeyToMatch ).GetMarshaledBytes(), nValueToMatch, nComparisonType ); 
		}
		...
		{
			this.GetFunction<NativeAddRequestLobbyListNearValueFilterSI>( this.Functions.AddRequestLobbyListNearValueFilter8 )( this.ObjectAddress, InteropHelp.Utf8StringToPtr( pchKeyToMatch ).GetMarshaledBytes(), nValueToBeCloseTo ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetLobbyDataCS>( this.Functions.GetLobbyData16 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ) ); 
		}
		...
		{
			return this.GetFunction<NativeSetLobbyDataCSS>( this.Functions.SetLobbyData17 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchValue ).GetMarshaledBytes() ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetLobbyMemberDataCCS>( this.Functions.GetLobbyMemberData18 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDUser.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ) ); 
		}
		...
		{
			this.GetFunction<NativeSetLobbyMemberDataCSS>( this.Functions.SetLobbyMemberData19 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchValue ).GetMarshaledBytes() ); 
		}
