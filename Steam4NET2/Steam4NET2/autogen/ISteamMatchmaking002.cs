...
namespace Steam4NET
{
	...
	public class ISteamMatchmaking002 : InteropHelp.NativeWrapper<ISteamMatchmaking002VTable>
	{
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetLobbyDataCS>( this.Functions.GetLobbyData12 )( this.ObjectAddress, SteamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ) ); 
		}
		
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate void NativeSetLobbyDataCSS( IntPtr thisptr, UInt64 steamIDLobby, IntPtr pchKey, IntPtr pchValue );
		public void SetLobbyData( CSteamID steamIDLobby, string pchKey, string pchValue ) 
		{
			this.GetFunction<NativeSetLobbyDataCSS>( this.Functions.SetLobbyData13 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchValue ).GetMarshaledBytes() ); 
		}
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetLobbyMemberDataCCS>( this.Functions.GetLobbyMemberData14 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDUser.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ) ); 
		}
		...
		{
			this.GetFunction<NativeSetLobbyMemberDataCSS>( this.Functions.SetLobbyMemberData15 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchValue ).GetMarshaledBytes() ); 
		}
