...
namespace Steam4NET
{
	...
	public class ISteamUserStats001 : InteropHelp.NativeWrapper<ISteamUserStats001VTable>
	{
		...
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetGroupAchievementNameCU>( this.Functions.GetGroupAchievementName6 )( this.ObjectAddress, arg0.ConvertToUint64(), iAchievement ) ); 
		}
		...
		{
			return this.GetFunction<NativeGetStatCSF>( this.Functions.GetStat8 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), ref pData ); 
		}
		...
		{
			return this.GetFunction<NativeGetStatCSI>( this.Functions.GetStat9 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), ref pData ); 
		}
		...
		{
			return this.GetFunction<NativeSetStatCSF>( this.Functions.SetStat10 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), fData ); 
		}
		...
		{
			return this.GetFunction<NativeSetStatCSI>( this.Functions.SetStat11 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), nData ); 
		}
		
		[return: MarshalAs(UnmanagedType.I1)]
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeUpdateAvgRateStatCSFD( IntPtr thisptr, UInt64 nGameID, IntPtr pchName, float arg2, double dSessionLength );
		public bool UpdateAvgRateStat( CGameID nGameID, string pchName, float arg2, double dSessionLength ) 
		{
			return this.GetFunction<NativeUpdateAvgRateStatCSFD>( this.Functions.UpdateAvgRateStat12 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), arg2, dSessionLength ); 
		}
		
		[return: MarshalAs(UnmanagedType.I1)]
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeGetAchievementCSB( IntPtr thisptr, UInt64 nGameID, IntPtr pchName, ref bool pbAchieved );
		public bool GetAchievement( CGameID nGameID, string pchName, ref bool pbAchieved ) 
		{
			return this.GetFunction<NativeGetAchievementCSB>( this.Functions.GetAchievement13 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), ref pbAchieved ); 
		}
		
		[return: MarshalAs(UnmanagedType.I1)]
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeGetGroupAchievementCSB( IntPtr thisptr, UInt64 nGameID, IntPtr pchName, ref bool pbAchieved );
		public bool GetGroupAchievement( CGameID nGameID, string pchName, ref bool pbAchieved ) 
		{
			return this.GetFunction<NativeGetGroupAchievementCSB>( this.Functions.GetGroupAchievement14 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), ref pbAchieved ); 
		}
		...
		{
			return this.GetFunction<NativeSetAchievementCS>( this.Functions.SetAchievement15 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes() ); 
		}
		
		[return: MarshalAs(UnmanagedType.I1)]
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeSetGroupAchievementCS( IntPtr thisptr, UInt64 nGameID, IntPtr pchName );
		public bool SetGroupAchievement( CGameID nGameID, string pchName ) 
		{
			return this.GetFunction<NativeSetGroupAchievementCS>( this.Functions.SetGroupAchievement16 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes() ); 
		}
		...
		{
			return this.GetFunction<NativeClearAchievementCS>( this.Functions.ClearAchievement18 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes() ); 
		}
		
		[return: MarshalAs(UnmanagedType.I1)]
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeClearGroupAchievementCS( IntPtr thisptr, UInt64 nGameID, IntPtr pchName );
		public bool ClearGroupAchievement( CGameID nGameID, string pchName ) 
		{
			return this.GetFunction<NativeClearGroupAchievementCS>( this.Functions.ClearGroupAchievement19 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes() ); 
		}
		
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate Int32 NativeGetAchievementIconCS( IntPtr thisptr, UInt64 nGameID, IntPtr pchName );
		public Int32 GetAchievementIcon( CGameID nGameID, string pchName ) 
		{
			return this.GetFunction<NativeGetAchievementIconCS>( this.Functions.GetAchievementIcon20 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes() ); 
		}
		
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate IntPtr NativeGetAchievementDisplayAttributeCSS( IntPtr thisptr, UInt64 nGameID, IntPtr pchName, IntPtr pchKey );
		public string GetAchievementDisplayAttribute( CGameID nGameID, string pchName, string pchKey ) 
		{
			return InteropHelp.Utf8PtrToString( this.GetFunction<NativeGetAchievementDisplayAttributeCSS>( this.Functions.GetAchievementDisplayAttribute21 )( this.ObjectAddress, nGameID.ConvertToUint64(), InteropHelp.Utf8StringToPtr( pchName ).GetMarshaledBytes(), InteropHelp.Utf8StringToPtr( pchKey ).GetMarshaledBytes() ) ); 
		}
